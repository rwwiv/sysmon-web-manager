        ...
        <div class="box-header with-border">
          <table class="table no-margin edit-all">
            ...
            <tr>
              ...
              <th class="edit-all-options pull-left">
              ...
              <th class="pull-right">
                <div v-if="groupSaving" id="container-createGroupBtn">
                  <button type="button" class="btn btn-primary" id="btn-createGroup" data-toggle="modal" data-target="#createGroupModal">
